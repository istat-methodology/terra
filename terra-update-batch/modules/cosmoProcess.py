...
def monthlyProcessing(path_to_scan, logger):
    ...
    duckdb_temp_directory = os.getenv('DUCKDB_LOCATION', '/tmp')
    try:
        with duckdb.connect() as con:
            con.execute(f"SET temp_directory='{duckdb_temp_directory}'")
        ...
        shutil.rmtree(duckdb_temp_directory, ignore_errors=True)